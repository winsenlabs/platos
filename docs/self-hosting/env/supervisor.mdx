---
title: "Supervisor"
description: "Environment variables for an external Trigger supervisor container."
sidebarTitle: "Supervisor"
mode: "wide"
---

> The supervisor belongs to a separately deployed Trigger application. Platos
> does not run this container locally; configure it only within the external
> Trigger deployment.

| Name                                        | Required | Default     | Description                                                 |
| :------------------------------------------ | :------- | :---------- | :---------------------------------------------------------- |
| **Required settings**                       |          |             |                                                             |
| `TRIGGER_API_URL`                           | Yes      | —           | Trigger.dev API URL. Should point at the external Trigger webapp. |
