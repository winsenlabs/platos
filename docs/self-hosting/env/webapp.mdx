...
| **Postgres**                                     |          |                       |                                                                                                                    |
| `DATABASE_URL`                                   | Yes      | —                     | Canonical clean PostgreSQL connection string shared with the agent.                                                |
| `DIRECT_URL`                                     | Yes      | —                     | Direct connection to the same canonical clean database as `DATABASE_URL`.                                         |
...
| <span id="run-engine">**Run engine**</span>      |          |                       |                                                                                                                    |
