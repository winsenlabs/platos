...
> This chart deploys **external Trigger infrastructure**. It is not installed
> into, or owned by, the Platos application stack. Keep its workers, secrets,
> queues, schedules, and PostgreSQL data independent from Platos.
