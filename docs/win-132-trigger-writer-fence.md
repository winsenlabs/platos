# WIN-132 external Trigger writer fence
...
- any non-completed or malformed response throws a stable Trigger-side error so
  the Trigger run is recorded as failed.
