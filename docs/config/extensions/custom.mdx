...
You should also take a look at Trigger.dev's built-in extensions for inspiration on how to create your own. See the external [`@trigger.dev/build` documentation](https://trigger.dev/docs/config/extensions/overview).
