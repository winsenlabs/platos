...
<Note>
  ...
  bundling](/guides/frameworks/nextjs#triggering-your-task-in-nextjs).
</Note>
...
### yourTask.trigger() {#yourtask-trigger}
...
### yourTask.batchTrigger() {#yourtask-batchtrigger}
...
### yourTask.triggerAndWait() {#yourtask-triggerandwait}
...
### yourTask.batchTriggerAndWait() {#yourtask-batchtriggerandwait}
...
### batch.triggerAndWait() {#batch-triggerandwait}
...
### batch.triggerByTask() {#batch-triggerbytask}
...
### batch.triggerByTaskAndWait() {#batch-triggerbytaskandwait}
