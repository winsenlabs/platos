...
| [Middleware & locals](/tasks/overview#middleware-and-locals-functions) | The middleware system runs at the top level, executing before and after all lifecycle hooks. The locals API allows sharing data between middleware and hooks.                                              |
...
```ts
// Deprecated historical module specifier; do not copy: @trigger.dev/sdk/v3
