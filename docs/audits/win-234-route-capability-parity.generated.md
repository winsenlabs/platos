...
|---|---:|---|
| permission | 38 | Verify permission behavior or record an approved not-applicable/justified-exclusion status. |
| organization scope | 34 | Verify Organization isolation or record an approved not-applicable status. |
| project scope | 34 | Verify Project isolation or record an approved not-applicable status. |
| environment scope | 34 | Verify Environment isolation or record an approved not-applicable status. |
...
| form behavior | 14 | Verify form behavior or record an approved redirect/not-applicable status. |
| link behavior | 39 | Verify link and deep-link behavior or record an approved redirect/not-applicable status. |
| destructive confirmation | 5 | Verify destructive confirmation or record an approved not-applicable/justified-exclusion status. |
...
| concurrency | 13 | Verify concurrent behavior or record an approved not-applicable/justified-exclusion status. |
| recovery | 37 | Verify failure, retry, and unavailable-backend recovery or record an approved not-applicable/justified-exclusion status. |
| secret exposure | 38 | Verify secret-safe payloads, errors, logs, storage, and snapshots or record an approved not-applicable/justified-exclusion status. |
| persisted-state evidence | 3 | Provide create/update/delete/read-back evidence against the canonical clean-schema owner. |
| automated behavioral evidence | 34 | Replace static or pending references with passing behavioral test evidence. |
