...
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs.$jobId/route.tsx` | `route-059` | improve | NONE Route module apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs.$jobId/route.tsx | not-applicable | static-contract-only | static-contract-only | required-not-verified |
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs._index/route.tsx` | `route-060` | improve | NONE Route module apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs._index/route.tsx | not-applicable | static-contract-only | static-contract-only | required-not-verified |
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs.new/route.tsx` | `route-061` | improve | NONE Route module apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.jobs.new/route.tsx | not-applicable | static-contract-only | static-contract-only | required-not-verified |
