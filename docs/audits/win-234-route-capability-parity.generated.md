...
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.agents.$agentId.chat/route.tsx` | `attachment-presign-upload` | improve | POST /api/v1/agent/attachments/presigned | confirmed-defect | confirmed-defect | static-contract-only | required-not-verified |
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.agents.$agentId.chat/route.tsx` | `message-rating-lifecycle` | improve | GET /api/v1/agent/messages/:messageId/rating; POST /api/v1/agent/messages/:messageId/rating; DELETE /api/v1/agent/messages/:messageId/rating | required-not-verified | confirmed-defect | static-contract-only | required-not-verified |
...
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.threads.$threadId/route.tsx` | `message-pagination` | improve | GET /api/v1/agent/threads/:threadId/messages | confirmed-defect | confirmed-defect | static-contract-only | required-not-verified |
...
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.threads.$threadId/route.tsx` | `thread-artifacts` | improve | GET /api/v1/agent/threads/:threadId/artifacts | confirmed-defect | confirmed-defect | static-contract-only | required-not-verified |
| `apps/webapp/app/routes/_app.orgs.$organizationSlug.projects.$projectParam.env.$envParam.threads.$threadId/route.tsx` | `thread-fork` | improve | POST /api/v1/agent/threads/:threadId/fork | required-not-verified | confirmed-defect | static-contract-only | required-not-verified |
