...
|---|---:|---|
| permission | 52 | Verify permission behavior or record an approved not-applicable/justified-exclusion status. |
| organization scope | 40 | Verify Organization isolation or record an approved not-applicable status. |
| project scope | 40 | Verify Project isolation or record an approved not-applicable status. |
| environment scope | 40 | Verify Environment isolation or record an approved not-applicable status. |
...
| link behavior | 61 | Verify link and deep-link behavior or record an approved redirect/not-applicable status. |
...
| recovery | 57 | Verify failure, retry, and unavailable-backend recovery or record an approved not-applicable/justified-exclusion status. |
| secret exposure | 58 | Verify secret-safe payloads, errors, logs, storage, and snapshots or record an approved not-applicable/justified-exclusion status. |
| persisted-state evidence | 9 | Provide create/update/delete/read-back evidence against the canonical clean-schema owner. |
| automated behavioral evidence | 42 | Replace static or pending references with passing behavioral test evidence. |
