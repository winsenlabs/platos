...
Evidence SHA-256: `797faaa2a93311e92582b89522632c62a921c965786c516ce8aee62c99c01907`
...
| `packages/adapters/channel-telegram` | `@platos/adapter-channel-telegram` | yes | yes | yes | yes | retain-oci-image | no | no | `cbfa771713ff02b7…` |
| `packages/adapters/channel-whatsapp` | `@platos/adapter-channel-whatsapp` | yes | yes | yes | yes | retain-oci-image | no | no | `2624ee8d4381ffa2…` |
...
| `packages/adapters/keyring-envelope` | `@platos/adapter-keyring-envelope` | yes | yes | yes | yes | retain-oci-image | no | no | `b9d45da524fc8183…` |
...
| `packages/adapters/redis-cache` | `@platos/adapter-redis-cache` | yes | yes | yes | yes | retain-oci-image | no | no | `df9ace773381183e…` |
...
| `packages/contexts/agents` | `@platos/context-agents` | yes | yes | yes | yes | retain-oci-image | no | no | `d90b05ba281f9df8…` |
| `packages/contexts/channels` | `@platos/context-channels` | yes | yes | yes | yes | retain-oci-image | no | no | `98e70247b2871458…` |
...
| `packages/contexts/files` | `@platos/context-files` | yes | yes | yes | yes | retain-oci-image | no | no | `7097ee97d5350fd2…` |
| `packages/contexts/governance` | `@platos/context-governance` | yes | yes | yes | yes | retain-oci-image | no | no | `7b9be14470805caf…` |
| `packages/contexts/identity-access` | `@platos/context-identity-access` | yes | yes | yes | yes | retain-oci-image | no | no | `68af4dfc7793f889…` |
...
| `packages/contexts/providers` | `@platos/context-providers` | yes | yes | yes | yes | retain-oci-image | no | no | `a37121f965907147…` |
...
| `packages/contexts/tenancy` | `@platos/context-tenancy` | yes | yes | yes | yes | retain-oci-image | no | no | `1cd36c5c96fc84bd…` |
...
| `packages/kernel` | `@platos/kernel` | yes | yes | yes | yes | retain-oci-image | no | no | `f0261d53dfa58d2e…` |
