...
Evidence SHA-256: `56736f2e776e059e8e949963e2e3343d75a31eaf80f7a6ba52cba97e192d1302`
...
| `apps/webapp` | `webapp` | yes | yes | yes | yes | retain-oci-image | no | no | `e3194504657c7a9d…` |
...
| `internal-packages/run-engine` | `@internal/run-engine` | no | no | no | no | owner-review-repository-referenced | no | yes | `8a8d04d032041dbf…` |
...
| `packages/kernel` | `@platos/kernel` | yes | yes | yes | yes | retain-oci-image | no | no | `d8c86452d1a0779d…` |
