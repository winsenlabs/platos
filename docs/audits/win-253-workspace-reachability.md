...
Evidence SHA-256: `622290754db9c89a037b26fa23faf8ce46bffe1f593b82fea97cc2d029c8dcf0`
...
| --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- |
| `apps/agent` | `platos-agent` | yes | yes | yes | yes | retain-oci-image | no | no | `72fdc8e348654593…` |
