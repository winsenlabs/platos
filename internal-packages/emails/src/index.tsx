...
export class EmailClient {
  ...
  #getTemplate(data: DeliverEmail): {
    ...
    switch (data.email) {
      case "magic_link":
        return {
          subject: "Magic sign-in link for Platos",
          component: <MagicLinkEmail magicLink={data.magicLink} />,
        };
      case "invite":
        return {
          subject: `You've been invited to join ${data.orgName} on Platos`,
      ...
      case "mfa-enabled": {
        return {
          subject: `Multi-factor authentication enabled on your Platos account`,
          component: <MfaEnabledEmail {...data} />,
        };
      }
      case "mfa-disabled": {
        return {
          subject: `Multi-factor authentication disabled on your Platos account`,
