import { calculateNextRetryDelay } from "@platos/core/v3";
 ...
 *
 * Uses the same algorithm as @platos/core's calculateNextRetryDelay.
 */
...
/**
 * Default retry options matching @platos/core defaults.
 */
