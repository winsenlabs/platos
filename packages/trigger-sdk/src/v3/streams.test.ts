...
import { taskContext, realtimeStreams } from "@platos/core/v3";

vi.mock("@platos/core/v3", async (importOriginal) => {
    const original = await importOriginal<typeof import("@platos/core/v3")>();
    return {
        ...original,
        taskContext: {
            ctx: {
