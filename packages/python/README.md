...
For more detailed documentation, visit the Platos docs at [platos.dev/docs](https://platos.dev/docs). Platos is built on top of [trigger.dev](https://trigger.dev) — see also [trigger.dev/docs](https://trigger.dev/docs) for the underlying engine reference.
