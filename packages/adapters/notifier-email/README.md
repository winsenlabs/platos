# @platos/adapter-notifier-email

Implements TWO owner-supplied ports — outbound email over one SMTP relay:

- the cost-monitoring `Notifier` port
- the identity-access `MagicLinkDelivery` port
