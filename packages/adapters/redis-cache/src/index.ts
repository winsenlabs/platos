...
// composition root needs to bind two ports and to close one connection — and the
// connection seam, so a suite can drive the stores against a container without
// this package deciding how a test reaches one.
