# @platos/adapter-channel-whatsapp

Implements TWO owner-supplied ports — WhatsApp Cloud API: HMAC-SHA256 inbound, Graph REST outbound:

- the channels `ChannelAdapter` port
- the channels `ChannelRuntime` port
