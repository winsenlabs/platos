# @platos/adapter-tokenmint-totp

Implements TWO owner-supplied ports — the credential randomness and the RFC 6238 keyed hash over one base32 alphabet:

- the identity-access `TokenMinter` port
- the identity-access `TotpCodeVerifier` port
