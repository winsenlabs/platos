...
export type { EnvironmentScope, Money, NotResult, Result, TransactionScope } from "@platos/kernel";
...
export { asIdentifier, environmentScope, err, moneyToCentsString, ok, runResult } from "@platos/kernel";
