...
echo "Running: pnpm run clean --filter \"@platos/*\" --filter \"@platosdev/*\""
pnpm run clean --filter "@platos/*" --filter "@platosdev/*"

echo "Running: pnpm run build --filter \"@platos/*\" --filter \"@platosdev/*\""
pnpm run build --filter "@platos/*" --filter "@platosdev/*"
