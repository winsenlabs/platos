...
test("CI policy controls fail under generated semantic source mutations", async (t) => {
  ...
  // DELTA — WIN-284 moves 340 to 349, and every one of the nine is attributable:
  //   +1  the fourth ci.yml setup-node, generated one control per occurrence by
  //       the expectedSetupNodeCounts loop, belonging to the new
  ...
  //   +4  the negative-control step deleted, made conditional, stripped of the
  //       seeded-divergence catalogue, and the twin-store job stopping running
  //       the store gate.
