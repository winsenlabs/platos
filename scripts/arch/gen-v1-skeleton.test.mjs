...
test("--check accepts the live generated tree and reports both ownership tiers", () => {
  ...
  // client (ADR M0.3 §15).
  // 99 -> 103 (WIN-258 T5): packages/adapters/postgres-tenancy ->
  // packages/contexts/channels, -> packages/contexts/governance, ->
  // packages/contexts/secrets and -> packages/contexts/skills, the sixth,
  // seventh, eighth and ninth owners of that same client. FOUR edges for NINE
