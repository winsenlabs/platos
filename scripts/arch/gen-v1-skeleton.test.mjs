...
test("§15 refusal: a FIFTY-EIGHTH binding fails, even though a directory may hold more than one", () => {
  ...
  assert.ok(errors.some((error) => error.includes("declares 57 adapter bindings; ADAPTERS flattens to 58")));
});
