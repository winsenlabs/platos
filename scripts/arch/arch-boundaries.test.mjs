...
describe("ADR M0.3 boundary enforcement — each rule catches a violation and passes a compliant fixture", () => {
  ...
  it("the real repository scan is clean and non-vacuous", () => {
    ...
    // M2 INTEGRATION DELTA — 104 -> 441. Four adopting slices make disjoint
    ...
    // 310 + 44 = 354 with neither providers nor the apps. All four slices are
    // disjoint, so the integrated census is 397 + 44 = 354 + 65 + 22 = 441.
    //
    ...
    assert.equal(result.fileCount, 441, "the generated V1 source census must stay exact");
