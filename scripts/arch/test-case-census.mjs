 ...
 *
 * 20 + 6 + 6 + 7 + 6 = 45 files and 199 + 59 + 60 + 65 + 66 = 449 cases. The
 * tree total is 391 + 25 = 416 files and 6115 + 250 = 6365 cases. The adapters
 * term of the three-way identity carries all twenty-five, because every added
 * file is an adapter's: 39 + 25 = 64, and 349 + 3 + 64 = 416.
 */
export const EXPECTED = Object.freeze({
  ...
  "packages/adapters/postgres-tenancy": { files: 45, cases: 449 },
 ...
 * database in it.
 */
export const EXPECTED_RUNTIME_TOTAL = 6365;
