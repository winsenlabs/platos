...
test("the census is not vacuous — it reads the real suites", () => {
  ...
  assert.equal(live.totalFiles, 574);
...
test("the pinned rows sum to the pinned runtime total", () => {
  ...
  assert.equal(files, 574);
  assert.equal(files, /* WIN-268 stage 3 lifecycle suites, one per term */ (1 + 1) + /* WIN-268 P1 mint suite */ 1 + 503 + 6 + 12 + 5 + (2 + 1 + 1) + (1 + 2) + 7 + 3 + 2 + 3 + 1 + /* WIN-271 */ (5 + 1) + /* WIN-272 */ (3 + 1) + /* WIN-268 stage 2 tools/adapters */ 2 + /* 2026-09-15 notifier-email 2, identity-access 1, tenancy 2 */ 5 + /* WIN-271 D10 channel-discord */ 5);
});
