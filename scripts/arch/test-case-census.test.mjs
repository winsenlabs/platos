...
test("the census is not vacuous — it reads the real suites", () => {
  ...
  assert.equal(live.totalFiles, 508);
  ...
  // WIN-260 (M2.5) adds the last two terms: 1 under
  // `packages/adapters/postgres-tenancy` (`correlation.integration.test.ts`)
  // and 3 under the newly adopted `packages/adapters/redis-cache`.
  //
  // AND ONE MORE (WIN-260's errors-and-idempotency dimension):
  // `packages/adapters/redis-cache/src/request-idempotency.test.ts`. Its four
  // sibling suites are `apps/core-api`'s, which is outside PACKAGE_ROOTS and has
  // no row in this census at all — the v1 ledger counts those four.
  // 507 + 1 = 508.
  assert.equal(live.totalFiles, 88 + 14 + 20 + 16 + 28 + 21 + 15 + 15 + 25 + 19 + 15 + 31 + 4 + 2 + 15 + 29 + 1 + 2 + 4 + 3 + 4 + 7 + 5 + 4 + 4 + 6 + 6 + 6 + 1 + 6 + 6 + 9 + 7 + 8 + 6 + 7 + 6 + 7 + 7 + 5 + 6 + 3 + 6 + 3 + 1 + 1 + 3 + 1);
...
test("the providers context is pinned at what vitest prints", () => {
  ...
  // eleven ways cannot.
  assert.equal(EXPECTED_RUNTIME_TOTAL, 717 + 375 + 149 + 306 + 378 + 605 + 352 + 254 + 288 + 515 + 362 + 269 + 609 + 198 + 25 + 29 + 59 + 34 + 1 + 350 + 56 + 67 + 43 + 41 + 33 + 59 + 60 + 61 + 4 + 72 + 66 + 83 + 77 + 97 + 62 + 89 + 76 + 97 + 100 + 52 + 56 + 48 + 83 + 36 + 6 + 8 + 5 + 9 + 40 + 25);
});
...
test("the skills adoption is pinned, and moved nothing else", () => {
  ...
  assert.equal(
    sum + 149 + 306 + 378 + 605 + 352 + 254 + 288 + 515 + 362 + 269 + 609 + 198 + 350 + 56 + 67 + 43 + 41 + 33 + 59 + 60 + 61 + 4 + 72 + 66 + 83 + 77 + 97 + 62 + 89 + 76 + 97 + 100 + 52 + 56 + 48 + 83 + 36 + 6 + 8 + 5 + 9 + 40 + 25,
    EXPECTED_RUNTIME_TOTAL,
  );
});
...
test("the conversations context is pinned at what vitest prints", () => {
  ...
  assert.equal(EXPECTED_RUNTIME_TOTAL, 5525 + 350 + 56 + 67 + 43 + 41 + 33 + 59 + 60 + 61 + 4 + 72 + 66 + 83 + 77 + 97 + 62 + 89 + 76 + 97 + 100 + 52 + 56 + 48 + 83 + 36 + 6 + 8 + 5 + 9 + 40 + 25);
});
...
test("the postgres-tenancy adapter is pinned at what vitest prints", () => {
  ...
  assert.equal(EXPECTED["packages/adapters/postgres-tenancy"].cases, 1492);
  ...
  // WIN-260 (M2.5) adds the last four terms, and they are FOUR because the
  // dimension moved four rows: `jobs` +8, `adapters/outbox` +5,
  // `adapters/postgres-tenancy` +9 and the newly adopted
  // `adapters/redis-cache` +40. 7399 + 62 = 7461.
  //
  // AND A FIFTEENTH TERM: WIN-260's errors-and-idempotency dimension adds +25 to
  // `adapters/redis-cache` and to nothing else in this census, because its four
  // other suites are `apps/core-api`'s and that project is outside PACKAGE_ROOTS.
  // 7461 + 25 = 7486.
  assert.equal(EXPECTED_RUNTIME_TOTAL, 5875 + 56 + 67 + 43 + 41 + 33 + 59 + 60 + 61 + 4 + 72 + 66 + 83 + 77 + 97 + 62 + 89 + 76 + 97 + 100 + 52 + 56 + 48 + 83 + 36 + 6 + 8 + 5 + 9 + 40 + 25);
  assert.equal(
    EXPECTED_RUNTIME_TOTAL,
    Object.values(EXPECTED).reduce((total, row) => total + row.cases, 0)
  );
