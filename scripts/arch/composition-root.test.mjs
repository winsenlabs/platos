...
test("the live repository satisfies both the boundary rules and the composition-root audit", () => {
  ...
  // 13 -> 14 (WIN-258 T5): `postgres-tenancy:BudgetRepository`, the third owner
  // of the one PostgreSQL client. The DIRECTORY count deliberately does not
  // move, which is the whole content of the amendment.
