        ...
        <div className="mt-4">
          {showProjectSelection && (
            <div className="flex flex-col gap-4">
              ...
              <Paragraph className="text-sm">
                Choose which Vercel project to connect with this Platos project.
          ...
          {showEnvMapping && (
            <div className="flex flex-col gap-4">
              ...
              <Paragraph className="text-sm">
                Select which custom Vercel environment should map to Platos's Staging
          ...
          {showEnvVarSync && (
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                {/* TODO(Theme-P): point at docs.platos.dev/vercel-integration once the docs site ships */}
                If you are using Supabase or Neon branching, <TextLink href="https://github.com/platos-dev/platos#vercel-integration" target="_blank" rel="noopener noreferrer">read the docs</TextLink> for the recommended setup.
                </Paragraph>
              </div>
          ...
          {showGitHubConnection && (
            <div className="flex flex-col gap-4">
              ...
              <Paragraph className="text-sm">
                To fully integrate with Vercel, Platos needs access to your source code.
                This allows automatic deployments and build synchronization.
              </Paragraph>

              <Callout variant="info">
                <p className="text-xs">
                  Connecting your GitHub repository enables Platos to read your source code
