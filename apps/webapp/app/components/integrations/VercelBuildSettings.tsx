    ...
    <>
      ...
      <div>
        ...
        <Hint className="pr-6">
          ...
          promoting the Platos deployment. This will disable the "Auto-assign Custom Production
          Domains" option in your Vercel project settings to perform staged deployments.{" "}
          {/* TODO(Theme-P): swap for docs.platos.dev/vercel-integration once it ships */}
          <TextLink href="https://github.com/platos-dev/platos#vercel-integration" target="_blank">
            Learn more
          </TextLink>
          .
        </Hint>
      ...
      {atomicBuilds.includes("prod") && onAutoPromoteChange !== undefined && (
        <div>
          ...
          <Hint className="pr-6">
            ...
            the Platos build completes. Turn off to manually promote from your Vercel
            dashboard — Platos will then promote automatically once you do.
          </Hint>
        </div>
      )}
    </>
