...
const variants = {
  ...
  success:
    "grid place-items-center rounded-full px-2 h-5 tracking-wider text-xxs bg-emerald-950 text-emerald-300 border border-emerald-800 uppercase whitespace-nowrap",
  error:
    "grid place-items-center rounded-full px-2 h-5 tracking-wider text-xxs bg-rose-950 text-rose-300 border border-rose-800 uppercase whitespace-nowrap",
};
