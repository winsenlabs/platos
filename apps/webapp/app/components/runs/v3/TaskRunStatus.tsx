...
import { runFriendlyStatus, type RunFriendlyStatus } from "@platos/core/v3";
...
export function TaskRunStatusReason({
  ...
  return (
    // TODO(Theme-P): replace with docs.platos.dev once the docs site ships
    <Callout to="https://github.com/platos-dev/platos#docs" variant="warning" className="text-sm">
      {description}
    </Callout>
  );
}
...
// runFriendlyStatus and RunFriendlyStatus are imported from @platos/core/v3
// and re-exported here for backward compatibility.
export { runFriendlyStatus, type RunFriendlyStatus } from "@platos/core/v3";
