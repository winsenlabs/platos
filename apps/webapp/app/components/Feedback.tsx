            ...
            <Fieldset className="max-w-full gap-y-3">
              ...
              <InputGroup className="max-w-full">
                {type === "feature" && (
                  ...
                  >
                    <Paragraph variant="small">
                      {/* TODO(Theme-BR-community): swap for a Platos-owned feedback surface once it exists */}
                      All feature requests are public and tracked on GitHub. The best way to
                      submit a feature request is to{" "}
                      <TextLink to="https://github.com/platos-dev/platos/issues/new?labels=feature-request">
                        open a GitHub issue
                      </TextLink>
                      .
                    </Paragraph>
                ...
                {type === "help" && (
                  ...
                  >
                    <Paragraph variant="small">
                      {/* TODO(Theme-BR-community): Platos has no Discord yet — community surface TBD */}
                      The quickest way to get help is to{" "}
                      <TextLink to="https://github.com/platos-dev/platos/discussions">
                        start a GitHub discussion
                      </TextLink>{" "}
                      or{" "}
                      <TextLink to="https://github.com/platos-dev/platos/issues/new">
                        open a GitHub issue
                      </TextLink>
                      .
                    </Paragraph>
