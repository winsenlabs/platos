      ...
      <div className="absolute inset-0 grid grid-cols-[100%] grid-rows-[2.5rem_1fr_auto] overflow-hidden">
        ...
        >
          <div className="mb-6 flex w-full flex-col gap-4 overflow-hidden px-1">
            ...
            {/* ═══════════════════════════════════════════════
                PLATFORM ENGINE — durable task runtime (trigger-native).
                Still every primitive Platos is built on; just moved below
                the agent-first navigation.
                ═══════════════════════════════════════════════ */}
            <SideMenuSection
            ...
            >
              ...
              <SideMenuItem
                ...
                isCollapsed={isCollapsed}
              />
              {/* OSS launch: Preview branches is gated on the upstream
                  billing/platform stack and ships as a "coming soon"
                  placeholder. Hide the nav entry until the OSS billing
                  surface lands. The route still resolves to the placeholder
                  page if the user has a stale URL cached. */}
              {isManagedCloud && (
                <SideMenuItem
