          ...
          case "artifact_size_exceeds_limit": {
            ...
            switch (body.data.type) {
              case "deployment_context":
                errorMessage = `Artifact size (${sizeMB} MB) exceeds the allowed limit of ${limitMB} MB. Make sure you are in the correct directory of your Platos project. Reach out to us if you are seeing this error consistently.`;
                break;
              default:
