...
const config = { surface: "jobs" as const, title: "Create background Job", description: "Create Platos-native scheduled work without Trigger UI ownership.", endpoint: "/api/v1/agent/platos-tasks", secondaryEndpoint: undefined, provenance: "Canonical clean database ancestry and platos-agent API" };
