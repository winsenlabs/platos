...
const config = { surface: "mcp-config" as const, title: "MCP Entity", description: "Safe MCP config, bearer lifecycle and Environment-scoped Tool ACL.", endpoint: "/mcp/entity/:entityId/config", secondaryEndpoint: "/mcp/entity/:entityId/tokens", supportingEndpoint: "/mcp/entity/:entityId/tool-acl?limit=200&offset=0", transport: "mcp-management" as const, secondaryCollection: { defaultPageSize: 25, maxPageSize: 100, pageParam: "tokenPage", pageSizeParam: "tokenPageSize" }, provenance: "Canonical EntityMcpConfig, McpBearerToken and EntityToolPolicy read-back via isolated MCP management transport", notFoundAsResponse: true };
