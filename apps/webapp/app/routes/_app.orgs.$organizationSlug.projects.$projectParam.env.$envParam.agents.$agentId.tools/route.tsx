...
const config = { surface: "agent-tools", title: "Agent Tool exposure", description: "Shows Tools injected this Turn, find-only Tools, always-present runtime Tools, source Entity and live dispatchability.", endpoint: "/api/v1/agent/agents/:agentId/tool-mappings", secondaryEndpoint: "/api/v1/agent/agents/:agentId/categories", provenance: "Canonical clean database ancestry and platos-agent API" };
