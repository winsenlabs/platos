...
const config = { surface: "jobs" as const, title: "Create Job", description: "Create Platos-native scheduled work without external Trigger UI ownership.", endpoint: "/api/v1/agent/jobs", secondaryEndpoint: undefined, provenance: "Canonical clean database ancestry and platos-agent API" };
