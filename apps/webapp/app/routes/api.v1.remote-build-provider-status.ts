...
import { type RemoteBuildProviderStatusResponseBody } from "@platos/core/v3/schemas";
        ...
        return json(
          {
            status: "degraded",
            message:
              // TODO(Theme-P): swap docs link for docs.platos.dev/deployment/overview once docs site ships
              "Our remote build provider is currently facing issues. You can use the `--force-local-build` flag to build and deploy the image locally. Read more about local builds here: https://github.com/platos-dev/platos#local-builds",
