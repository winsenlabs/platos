...
import { DashboardShell } from "~/components/platos/DashboardShell";
...
export default function EnvironmentLayout(){const {workspace}=useLoaderData<typeof loader>();return <DashboardShell workspace={workspace}/>;}
