...
const config = { surface: "skills" as const, title: "Install Skill", description: "Install embedded official Skill configuration or import a custom package.", endpoint: "/api/v1/agent/skills", secondaryEndpoint: undefined, provenance: "Canonical clean database ancestry and platos-agent API" };
