...
const config = { surface: "budgets", title: "Budgets", description: "Cache-aware budget status, enforcement and once-only threshold events.", endpoint: "/api/v1/agent/budgets/status", secondaryEndpoint: "/api/v1/agent/budgets", provenance: "Canonical clean database ancestry and platos-agent API" };
