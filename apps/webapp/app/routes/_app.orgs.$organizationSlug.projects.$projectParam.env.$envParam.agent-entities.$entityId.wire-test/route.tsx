...
const config = { surface: "wire-test" as const, title: "Wire test", description: "Run a real gateway Wire test and display the underlying result.", endpoint: "/api/v1/agent/entities/:entityId", secondaryEndpoint: undefined, provenance: "Canonical clean database ancestry and platos-agent API" };
