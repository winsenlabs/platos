          ...
          {tab === "detail" ? (
            ...
            <div className="flex flex-col gap-4 py-3">
              {run.metadata ? (
                ...
                // TODO(Theme-P): replace with docs.platos.dev/runs/metadata once the docs site ships
                <Callout to="https://github.com/platos-dev/platos#run-metadata" variant="docs">
