...
const config = { surface: "monitoring", title: "Monitoring and usage", description: "Every semantic value comes from the canonical usage ledger. The dashboard only formats returned values.", endpoint: "/api/v1/agent/monitoring/summary", secondaryEndpoint: "/api/v1/agent/monitoring/cost-by-agent?days=7&limit=40", provenance: "Canonical clean database ancestry and platos-agent API" };
