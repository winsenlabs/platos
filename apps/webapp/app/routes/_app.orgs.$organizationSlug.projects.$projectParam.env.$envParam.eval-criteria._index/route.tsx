...
const config = { surface: "evals" as const, title: "Evaluation criteria", description: "Criterion definitions and judge configuration with cost-lane visibility.", endpoint: "/api/v1/agent/eval-criteria", secondaryEndpoint: undefined, collection: { defaultPageSize: 25, maxPageSize: 100, search: true, filters: ["agentId", "activeOnly"] }, provenance: "Canonical clean database ancestry and platos-agent API" };
