...
const config = { surface: "clusters" as const, title: "Cluster memory scope", description: "Explicit membership and the resulting widened runtime recall boundary.", endpoint: "/api/v1/agent/clusters/:clusterId", provenance: "Canonical clean database ancestry and platos-agent API" };
