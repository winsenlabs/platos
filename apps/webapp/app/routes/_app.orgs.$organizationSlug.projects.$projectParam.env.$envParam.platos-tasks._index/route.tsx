...
const config = { surface: "jobs" as const, title: "Platos background work", description: "Job-backed Platos work is distinct from external infrastructure tasks.", endpoint: "/api/v1/agent/platos-tasks", secondaryEndpoint: undefined, collection: { defaultPageSize: 25, maxPageSize: 100, search: true, filters: ["status"] }, provenance: "Canonical clean database ancestry and platos-agent API" };
