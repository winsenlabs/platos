...
import { getUserProvidedIdempotencyKey } from "@platos/core/v3/serverOnly";
import { Prisma, TaskRunAttemptStatus, TaskRunStatus } from "@platos/database";
  ...
  public async call(taskRun: FoundRun, env: AuthenticatedEnvironment) {
    return startSpanWithEnv(tracer, "ApiRetrieveRunPresenter.call", env, async () => {
      ...
      return {
        ...
        attemptCount: taskRun.attemptNumber ?? 0,
        attempts: [],
        relatedRuns: {
