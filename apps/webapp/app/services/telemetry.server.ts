  ...
  constructor({ postHogApiKey }: Options) {
    ...
    if (postHogApiKey) {
      this.#posthogClient = new PostHog(postHogApiKey, {
        host: env.POSTHOG_API_HOST || "https://us.i.posthog.com",
      });
    } else {
  ...
  platos = {
    agentCreated: ({
      ...
      this.#capture({
        ...
        event: "platos_agent_created",
        organizationId,
        eventProperties: { agentId, model },
      });
    },
    agentUpdated: ({
      organizationId,
      ...
      this.#capture({
        userId: organizationId,
        event: "platos_agent_config_updated",
        organizationId,
        eventProperties: { agentId, field },
      });
    },
    agentDeleted: ({
      organizationId,
      ...
      this.#capture({
        userId: organizationId,
        event: "platos_agent_deleted",
        organizationId,
        eventProperties: { agentId },
      });
    },
    entityConnected: ({
      organizationId,
      ...
      this.#capture({
        userId: organizationId,
        event: "platos_entity_connected",
        organizationId,
        eventProperties: { entityId },
      });
    },
    entityWireTest: ({
      organizationId,
      ...
      this.#capture({
        userId: organizationId,
        event: "platos_entity_wire_test",
        organizationId,
        eventProperties: { entityId, success },
      });
    },
    threadCreated: ({
      organizationId,
    ...
    skillToggled: ({
      ...
      this.#capture({
        userId: organizationId,
        event: "platos_skill_toggled",
        organizationId,
        eventProperties: { agentId, skillSlug, enabled },
      });
    },
  };
