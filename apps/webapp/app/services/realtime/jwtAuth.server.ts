...
import { validateJWT } from "@platos/core/v3/jwt";
    ...
    switch (result.code) {
      case "ERR_JWT_EXPIRED": {
        return {
          ok: false,
          error:
            "Public Access Token has expired. See https://github.com/platos-dev/platos#frontend-authentication for more information.",
        };
      }
      case "ERR_JWT_CLAIM_INVALID": {
        return {
          ok: false,
          error: `Public Access Token is invalid: ${result.error}. See https://github.com/platos-dev/platos#frontend-authentication for more information.`,
        };
      }
      default: {
        return {
          ok: false,
          error:
            "Public Access Token is invalid. See https://github.com/platos-dev/platos#frontend-authentication for more information.",
        };
      }
    }
  }
