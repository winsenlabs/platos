...
export function checkAuthorization(
  ...
  if (!entity.scopes || entity.scopes.length === 0) {
    return {
      authorized: false,
      reason:
        "Public Access Token has no permissions. See https://github.com/platos-dev/platos#frontend-authentication for more information.",
    };
  }
  ...
  return {
    ...
    reason: `Public Access Token is missing required permissions. Token has the following permissions: ${entity.scopes
      ...
      .join(
        ", "
      )}. See https://github.com/platos-dev/platos#frontend-authentication for more information.`,
  };
}
