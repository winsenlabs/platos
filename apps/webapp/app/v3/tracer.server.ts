...
import { flattenAttributes } from "@platos/core/v3";
...
export function attributesFromAuthenticatedEnv(env: AuthenticatedEnvironment): Attributes {
  return {
    ...
    [SemanticEnvResources.ENV_NAME]: env.name,
    ...
    [SemanticEnvResources.ORG_NAME]: env.organization.name,
