// WIN-302 — the contract factory of `identity-access`, named from `apps/core-api`
...
export { createIdentityAccessService } from "@platos/context-identity-access/application/index.js";
