// WIN-302 — the contract factory of `observability`, named from `apps/core-api`
...
export { createObservabilityContract } from "@platos/context-observability/application/index.js";
